...
import HighCharts from "./screens/highcharts/";
import NHDeviceInfo from "./screens/deviceinfo/";
import NHWechat from "./screens/wechat/";
import NHScan from "./screens/scan/";
import NHImagePicker from "./screens/image/";
import NHAmap from "./screens/amap/";
import NHNotification from "./screens/notification/";
import RNFileSystem from "./screens/fs/";
const Drawer = createDrawerNavigator(
  {
    ...
    NHDatePicker: { screen: NHDatePicker },
      TableComponet: { screen: TableComponent },
      HighCharts: { screen: HighCharts },
      NHDeviceInfo: { screen: NHDeviceInfo },
      NHWechat: { screen: NHWechat },
      NHScan: { screen: NHScan },
      NHImagePicker: { screen: NHImagePicker },
      NHAmap: { screen: NHAmap },
      NHNotification: { screen: NHNotification },
      RNFileSystem: { screen: RNFileSystem }
  },
  {
...
YellowBox.ignoreWarnings([
    ...
    'VirtualizedList: missing keys for items' // Just remove for the demo, for the release version this warning need to be solved.
])
export default () =>
  <Root>
    <AppContainer />
