      ...
      <Container style={styles.container}>
        ...
        <Content padder>
          <Card style={styles.mb}>
            <CardItem header>
              <Text>Xiaohui Demo</Text>
            </CardItem>
            <CardItem>
              <Body>
                <Text>
                  Xiaohui Demo is a free and open source framework that enable
            ...
            <CardItem>
              <Body>
                <Text>
                  Xiaohui Demo builds a layer on top of React Native that provides
            ...
            <CardItem>
              <Body>
                <Text>
                  Get on the mobile fast track with Xiaohui Demo, the
